...
class CameraActivity : AppCompatActivity(), Camera.PictureCallback, View.OnClickListener,
    ...
    private var mInformationButton: ImageButton?= null
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val clickListener = View.OnClickListener {view ->
            ...
            dialogBuilder.setMessage("Purpose of image is to prevent scamming of multiple trees for same user")
                .setCancelable(false)
        ...
        mInformationButton = findViewById<ImageButton>(R.id.informationButton)
        mInformationButton!!.setOnClickListener(clickListener)
    ...
    override fun onStart() {
        ...
        operationAttempt = GlobalScope.launch(Dispatchers.Main) {
            ...
            mInformationButton?.visibility = View.INVISIBLE
            ...
            mInformationButton?.visibility = View.VISIBLE
        }
    }
